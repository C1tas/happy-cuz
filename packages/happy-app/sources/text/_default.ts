...
export const en = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'This is a cuz version, just cuz.',
        whatsNew: 'What\'s New',
    ...
    settingsFeatures: {
        ...
        diagnosticsDescription: 'Tools for testing and debugging app functionality.',
        notificationTest: 'Notification Test',
        notificationTestSubtitle: 'Push notification diagnostics and round-trip testing',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Stop and resume with a new process',
        restartSessionFreshSubtitle: 'Start fresh session in same directory',
        restartSessionMissingBackendId: 'Cannot restart: no backend session ID',
        restartSessionMachineOffline: 'Cannot restart: machine is offline',
        restartSessionNeedsUpdate: 'Cannot restart: daemon needs update',
        restartProgressChecking: 'Checking session status…',
        restartProgressActiveTitle: 'Session is Active',
        restartProgressActiveMessage: ({ state }: { state: string }) => `This session is currently ${state}. Restarting will stop the current process.`,
        restartProgressConfirm: 'Restart',
        restartProgressStopping: 'Stopping session…',
        restartProgressStopped: 'Session stopped',
        restartProgressStarting: 'Starting session in remote mode…',
        restartProgressSpawningFresh: 'Starting new session…',
        restartProgressStarted: 'Session started',
        restartProgressLoading: 'Loading conversation…',
        restartProgressError: 'Restart Failed',
    ...
    welcome: {
        ...
        title: 'Codex and Claude Code mobile client built by CUZ',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesManuallyApproveEdits: 'Yes, manually approve edits',
