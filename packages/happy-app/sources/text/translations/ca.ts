...
export const ca: TranslationStructure = {
    ...
    status: {
        ...
        compressing: 'comprimint context\u2026',
        activeNow: 'Actiu ara',
        unknown: 'desconegut',
    },
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Aquesta és la versió cuz, just cuz.',
        whatsNew: 'Novetats',
    ...
    settingsFeatures: {
        ...
        diagnosticsDescription: 'Eines per provar i depurar la funcionalitat de l\'aplicació.',
        notificationTest: 'Prova de notificacions',
        notificationTestSubtitle: 'Diagnòstic de notificacions push i prova d\'anada i tornada',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Aturar i reprendre amb un nou procés',
        restartSessionFreshSubtitle: 'Iniciar una nova sessió al mateix directori',
        restartSessionMissingBackendId: 'No es pot reiniciar: falta el backend session ID',
        restartSessionMachineOffline: 'No es pot reiniciar: la màquina està desconnectada',
        restartSessionNeedsUpdate: 'No es pot reiniciar: el daemon necessita actualització',
        restartProgressChecking: 'Comprovant l\'estat de la sessió\u2026',
        restartProgressActiveTitle: 'La sessió està activa',
        restartProgressActiveMessage: ({ state }: { state: string }) => `Aquesta sessió està actualment en estat ${state}. Reiniciar aturarà el procés actual.`,
        restartProgressConfirm: 'Reiniciar',
        restartProgressStopping: 'Aturant la sessió\u2026',
        restartProgressStopped: 'Sessió aturada',
        restartProgressStarting: 'Iniciant la sessió en mode remote\u2026',
        restartProgressSpawningFresh: 'Iniciant una nova sessió\u2026',
        restartProgressStarted: 'Sessió iniciada',
        restartProgressLoading: 'Carregant la conversa\u2026',
        restartProgressError: 'Error en reiniciar',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesBypassPermissions: 'Sí, i omet permisos',
            yesManuallyApproveEdits: 'Sí, aprova les edicions manualment',
            tellClaudeWhatToChange: 'Digues a Claude què canviar',
