...
export const es: TranslationStructure = {
    ...
    status: {
        ...
        compressing: 'comprimiendo contexto\u2026',
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Esta es la versión cuz, just cuz.',
        whatsNew: 'Novedades',
    ...
    settingsFeatures: {
        ...
        diagnosticsDescription: 'Herramientas para probar y depurar la funcionalidad de la aplicación.',
        notificationTest: 'Prueba de notificaciones',
        notificationTestSubtitle: 'Diagnóstico de notificaciones push y prueba de ida y vuelta',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Detener y reanudar con un nuevo proceso',
        restartSessionFreshSubtitle: 'Iniciar nueva sesión en el mismo directorio',
        restartSessionMissingBackendId: 'No se puede reiniciar: falta el backend session ID',
        restartSessionMachineOffline: 'No se puede reiniciar: la máquina está desconectada',
        restartSessionNeedsUpdate: 'No se puede reiniciar: el daemon necesita actualización',
        restartProgressChecking: 'Comprobando el estado de la sesión\u2026',
        restartProgressActiveTitle: 'La sesión está activa',
        restartProgressActiveMessage: ({ state }: { state: string }) => `Esta sesión está actualmente en estado ${state}. Reiniciar detendrá el proceso actual.`,
        restartProgressConfirm: 'Reiniciar',
        restartProgressStopping: 'Deteniendo la sesión\u2026',
        restartProgressStopped: 'Sesión detenida',
        restartProgressStarting: 'Iniciando sesión en modo remote\u2026',
        restartProgressSpawningFresh: 'Iniciando nueva sesión\u2026',
        restartProgressStarted: 'Sesión iniciada',
        restartProgressLoading: 'Cargando conversación\u2026',
        restartProgressError: 'Error al reiniciar',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesBypassPermissions: 'Sí, y omitir permisos',
            yesManuallyApproveEdits: 'Sí, aprobar ediciones manualmente',
            tellClaudeWhatToChange: 'Decirle a Claude qué cambiar',
