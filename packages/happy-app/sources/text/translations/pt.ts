...
export const pt: TranslationStructure = {
    ...
    status: {
        ...
        compressing: 'comprimindo contexto\u2026',
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Esta é a versão cuz, just cuz.',
        whatsNew: 'Novidades',
    ...
    settingsFeatures: {
        ...
        diagnosticsDescription: 'Ferramentas para testar e depurar a funcionalidade do aplicativo.',
        notificationTest: 'Teste de notificações',
        notificationTestSubtitle: 'Diagnóstico de notificações push e teste de ida e volta',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Parar e retomar com um novo processo',
        restartSessionFreshSubtitle: 'Iniciar nova sessão no mesmo diretório',
        restartSessionMissingBackendId: 'Não é possível reiniciar: falta o backend session ID',
        restartSessionMachineOffline: 'Não é possível reiniciar: a máquina está offline',
        restartSessionNeedsUpdate: 'Não é possível reiniciar: o daemon precisa de atualização',
        restartProgressChecking: 'Verificando o estado da sessão\u2026',
        restartProgressActiveTitle: 'A sessão está ativa',
        restartProgressActiveMessage: ({ state }: { state: string }) => `Esta sessão está atualmente em estado ${state}. Reiniciar irá parar o processo atual.`,
        restartProgressConfirm: 'Reiniciar',
        restartProgressStopping: 'Parando a sessão\u2026',
        restartProgressStopped: 'Sessão parada',
        restartProgressStarting: 'Iniciando sessão em modo remote\u2026',
        restartProgressSpawningFresh: 'Iniciando nova sessão\u2026',
        restartProgressStarted: 'Sessão iniciada',
        restartProgressLoading: 'Carregando conversa\u2026',
        restartProgressError: 'Falha ao reiniciar',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesBypassPermissions: 'Sim, e ignorar permissões',
            yesManuallyApproveEdits: 'Sim, aprovar edições manualmente',
            tellClaudeWhatToChange: 'Dizer ao Claude o que mudar',
