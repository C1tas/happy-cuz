...
export const pl: TranslationStructure = {
    ...
    status: {
        ...
        compressing: 'kompresja kontekstu\u2026',
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'To jest wersja cuz, just cuz.',
        whatsNew: 'Co nowego',
    ...
    settingsFeatures: {
        ...
        diagnosticsDescription: 'Narzędzia do testowania i debugowania funkcji aplikacji.',
        notificationTest: 'Test powiadomień',
        notificationTestSubtitle: 'Diagnostyka powiadomień push i test okrężny',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Zatrzymaj i wznów z nowym procesem',
        restartSessionFreshSubtitle: 'Rozpocznij nową sesję w tym samym katalogu',
        restartSessionMissingBackendId: 'Nie można uruchomić ponownie: brak backend session ID',
        restartSessionMachineOffline: 'Nie można uruchomić ponownie: maszyna jest offline',
        restartSessionNeedsUpdate: 'Nie można uruchomić ponownie: daemon wymaga aktualizacji',
        restartProgressChecking: 'Sprawdzanie stanu sesji\u2026',
        restartProgressActiveTitle: 'Sesja jest aktywna',
        restartProgressActiveMessage: ({ state }: { state: string }) => `Ta sesja jest obecnie w stanie ${state}. Ponowne uruchomienie zatrzyma bieżący proces.`,
        restartProgressConfirm: 'Uruchom ponownie',
        restartProgressStopping: 'Zatrzymywanie sesji\u2026',
        restartProgressStopped: 'Sesja zatrzymana',
        restartProgressStarting: 'Uruchamianie sesji w trybie remote\u2026',
        restartProgressSpawningFresh: 'Uruchamianie nowej sesji\u2026',
        restartProgressStarted: 'Sesja uruchomiona',
        restartProgressLoading: 'Ładowanie konwersacji\u2026',
        restartProgressError: 'Ponowne uruchomienie nie powiodło się',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesBypassPermissions: 'Tak, i pomiń uprawnienia',
            yesManuallyApproveEdits: 'Tak, ręcznie zatwierdzaj edycje',
            tellClaudeWhatToChange: 'Powiedz Claude, co zmienić',
