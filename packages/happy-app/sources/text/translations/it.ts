...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Questa è la versione cuz, just cuz.',
        whatsNew: 'Novità',
    ...
    settingsFeatures: {
        ...
        diagnosticsDescription: 'Strumenti per testare e risolvere problemi delle funzionalità dell\'app.',
        notificationTest: 'Test notifiche',
        notificationTestSubtitle: 'Diagnostica delle notifiche push e test di andata e ritorno',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Ferma e riprendi con un nuovo processo',
        restartSessionFreshSubtitle: 'Avvia una nuova sessione nella stessa directory',
        restartSessionMissingBackendId: 'Impossibile riavviare: manca il backend session ID',
        restartSessionMachineOffline: 'Impossibile riavviare: la macchina è offline',
        restartSessionNeedsUpdate: 'Impossibile riavviare: il daemon necessita di aggiornamento',
        restartProgressChecking: 'Verifica dello stato della sessione\u2026',
        restartProgressActiveTitle: 'La sessione è attiva',
        restartProgressActiveMessage: ({ state }: { state: string }) => `Questa sessione è attualmente in stato ${state}. Il riavvio interromperà il processo corrente.`,
        restartProgressConfirm: 'Riavvia',
        restartProgressStopping: 'Arresto della sessione\u2026',
        restartProgressStopped: 'Sessione arrestata',
        restartProgressStarting: 'Avvio della sessione in modalità remote\u2026',
        restartProgressSpawningFresh: 'Avvio di una nuova sessione\u2026',
        restartProgressStarted: 'Sessione avviata',
        restartProgressLoading: 'Caricamento della conversazione\u2026',
        restartProgressError: 'Riavvio non riuscito',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesBypassPermissions: 'Sì, e ignora i permessi',
            yesManuallyApproveEdits: 'Sì, approva le modifiche manualmente',
            tellClaudeWhatToChange: 'Di a Claude cosa cambiare',
