...
export const zhHans: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        diagnostics: '诊断',
        diagnosticsDescription: '用于测试和调试应用功能的工具。',
        notificationTest: '通知测试',
        notificationTestSubtitle: 'Push 通知诊断和往返测试',
    },
    ...
    sessionInfo: {
        ...
        restartSession: '重启会话',
        restartSessionSubtitle: '停止并以新进程恢复',
        restartSessionFreshSubtitle: '在相同目录启动新会话',
        restartSessionMissingBackendId: '无法重启：缺少 backend session ID',
        restartSessionMachineOffline: '无法重启：机器离线',
        restartSessionNeedsUpdate: '无法重启：daemon 需要更新',
        restartProgressChecking: '正在检查 session 状态\u2026',
        restartProgressActiveTitle: 'Session 处于活跃状态',
        restartProgressActiveMessage: ({ state }: { state: string }) => `此 session 当前处于 ${state} 状态。重启将停止当前进程。`,
        restartProgressConfirm: '重启',
        restartProgressStopping: '正在停止 session\u2026',
        restartProgressStopped: 'Session 已停止',
        restartProgressStarting: '正在以 remote 模式启动 session\u2026',
        restartProgressSpawningFresh: '正在启动新会话\u2026',
        restartProgressStarted: 'Session 已启动',
        restartProgressLoading: '正在加载对话\u2026',
        restartProgressError: '重启失败',
    ...
    welcome: {
        ...
        title: 'CUZ 构建的 Codex 和 Claude Code 移动客户端',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesBypassPermissions: '是，并跳过所有权限',
            yesManuallyApproveEdits: '是，手动审批编辑',
            tellClaudeWhatToChange: '告诉 Claude 要改什么',
