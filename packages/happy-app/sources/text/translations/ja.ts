...
export const ja: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        diagnostics: '診断',
        diagnosticsDescription: 'アプリ機能のテストとデバッグのためのツール。',
        notificationTest: '通知テスト',
        notificationTestSubtitle: 'Push通知の診断とラウンドトリップテスト',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: '停止して新しいプロセスで再開',
        restartSessionFreshSubtitle: '同じディレクトリで新しいセッションを開始',
        restartSessionMissingBackendId: '再起動できません: backend session ID がありません',
        restartSessionMachineOffline: '再起動できません: マシンがオフラインです',
        restartSessionNeedsUpdate: '再起動できません: daemon の更新が必要です',
        restartProgressChecking: 'セッションの状態を確認中\u2026',
        restartProgressActiveTitle: 'セッションはアクティブです',
        restartProgressActiveMessage: ({ state }: { state: string }) => `このセッションは現在 ${state} の状態です。再起動すると現在のプロセスが停止します。`,
        restartProgressConfirm: '再起動',
        restartProgressStopping: 'セッションを停止中\u2026',
        restartProgressStopped: 'セッションが停止しました',
        restartProgressStarting: 'remote モードでセッションを起動中\u2026',
        restartProgressSpawningFresh: '新しいセッションを起動中\u2026',
        restartProgressStarted: 'セッションが起動しました',
        restartProgressLoading: '会話を読み込み中\u2026',
        restartProgressError: '再起動に失敗しました',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesBypassPermissions: 'はい、権限を省略する',
            yesManuallyApproveEdits: 'はい、編集を手動で承認',
            tellClaudeWhatToChange: 'Claudeに変更内容を伝える',
