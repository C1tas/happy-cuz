...
export const zhHant: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        diagnostics: '診斷',
        diagnosticsDescription: '用於測試和偵錯應用程式功能的工具。',
        notificationTest: '通知測試',
        notificationTestSubtitle: 'Push 通知診斷和往返測試',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: '停止並以新程序恢復',
        restartSessionFreshSubtitle: '在相同目錄啟動新工作階段',
        restartSessionMissingBackendId: '無法重新啟動：缺少 backend session ID',
        restartSessionMachineOffline: '無法重新啟動：機器離線',
        restartSessionNeedsUpdate: '無法重新啟動：daemon 需要更新',
        restartProgressChecking: '正在檢查 session 狀態\u2026',
        restartProgressActiveTitle: 'Session 處於活躍狀態',
        restartProgressActiveMessage: ({ state }: { state: string }) => `此 session 目前處於 ${state} 狀態。重新啟動將停止目前的程序。`,
        restartProgressConfirm: '重新啟動',
        restartProgressStopping: '正在停止 session\u2026',
        restartProgressStopped: 'Session 已停止',
        restartProgressStarting: '正在以 remote 模式啟動 session\u2026',
        restartProgressSpawningFresh: '正在啟動新工作階段\u2026',
        restartProgressStarted: 'Session 已啟動',
        restartProgressLoading: '正在載入對話\u2026',
        restartProgressError: '重新啟動失敗',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesBypassPermissions: '是，並略過所有權限',
            yesManuallyApproveEdits: '是，手動審核編輯',
            tellClaudeWhatToChange: '告訴 Claude 要改什麼',
