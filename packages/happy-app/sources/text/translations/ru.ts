...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'О программе',
        aboutFooter: 'Это версия cuz, just cuz.',
        whatsNew: 'Что нового',
    ...
    settingsFeatures: {
        ...
        diagnosticsDescription: 'Инструменты для тестирования и отладки функций приложения.',
        notificationTest: 'Тест уведомлений',
        notificationTestSubtitle: 'Диагностика push-уведомлений и тестирование доставки',
    },
    ...
    sessionInfo: {
        ...
        restartSessionSubtitle: 'Остановить и возобновить с новым процессом',
        restartSessionFreshSubtitle: 'Запустить новую сессию в той же директории',
        restartSessionMissingBackendId: 'Невозможно перезапустить: отсутствует backend session ID',
        restartSessionMachineOffline: 'Невозможно перезапустить: машина офлайн',
        restartSessionNeedsUpdate: 'Невозможно перезапустить: daemon требует обновления',
        restartProgressChecking: 'Проверка состояния сессии\u2026',
        restartProgressActiveTitle: 'Сессия активна',
        restartProgressActiveMessage: ({ state }: { state: string }) => `Эта сессия сейчас в состоянии ${state}. Перезапуск остановит текущий процесс.`,
        restartProgressConfirm: 'Перезапустить',
        restartProgressStopping: 'Остановка сессии\u2026',
        restartProgressStopped: 'Сессия остановлена',
        restartProgressStarting: 'Запуск сессии в режиме remote\u2026',
        restartProgressSpawningFresh: 'Запуск новой сессии\u2026',
        restartProgressStarted: 'Сессия запущена',
        restartProgressLoading: 'Загрузка диалога\u2026',
        restartProgressError: 'Ошибка перезапуска',
    ...
    claude: {
        ...
        permissions: {
            ...
            yesBypassPermissions: 'Да, и пропускать разрешения',
            yesManuallyApproveEdits: 'Да, одобрять правки вручную',
            tellClaudeWhatToChange: 'Сказать Claude, что изменить',
